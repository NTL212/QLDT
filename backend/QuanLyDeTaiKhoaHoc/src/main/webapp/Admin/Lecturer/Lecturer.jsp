...
<head>
	...
	<link rel="stylesheet" type = "text/css" href="<%=request.getContextPath()%>/Admin/Lecturer/Lecturer.css">
	...
	<div class = "container-fluid">
		<div class = "row">
			...
			<div class = "col-md-9">
	        	<div class = "row space-little">
		        	<div class = "table-container">
		        			<table>
			        			...
			        			<tbody>
			        				<tr>
			        					<c:if test="${listLect != null}">
				        				<c:forEach var="account" items="${listLect}">
										    <tr>
	        	...
	        	<div class = "row">
	        		<div class = "col">
		        		<a href="<%=request.getContextPath()%>/Admin/AddLecturer/AddLecturer.jsp" class="btn btn-primary"><i class="fas fa-plus"></i> Thêm</a>
	        		</div>
	        	</div>
	        </div>
		</div>
