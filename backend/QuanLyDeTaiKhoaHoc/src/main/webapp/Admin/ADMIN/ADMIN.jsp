...
<head>
	...
	<link rel="stylesheet" type = "text/css" href="<%=request.getContextPath()%>/Admin/ADMIN/ADMIN.css">
	<link rel="stylesheet" href="Admin/ADMIN/ADMIN.css">
	...
	<div class = "container-fluid">
		<div class = "row">
			...
			<div class = "col-md-9">
		        			...
		        			<table>
			        			...
			        			<tbody>
			        				<tr>    				
				        				...
				        				<c:forEach var="account" items="${listAdmin}">
										    <tr>
									            <td><c:out value="${account.getUsername()}" /></td>
												<td><c:out value="${account.getPassword()}" /></td>
												<td><c:out value="${account.getRole()}" /></td>
												<td>
  													<a href="<%=request.getContextPath()%>/admincontroller/deleteacc?adCode=<c:out value='${account.getUsername()}'/>" class="btn btn-info">
	        	...
	        	<div class = "row">
	        		<div class = "col">
		        		<a href="<%=request.getContextPath()%>/Admin/AddADMIN/AddADMIN.jsp" class="btn btn-primary"><i class="fas fa-plus"></i> Thêm</a>
	        		</div>
	        	</div>
	        </div>
		</div>
