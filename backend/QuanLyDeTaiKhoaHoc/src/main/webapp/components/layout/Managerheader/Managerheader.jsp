...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/components/layout/Managerheader/Managerheader.css">
</head>
<body>
	<div class="header">
		...
		<div class="dropdown">
			...
			<div class="dropdown-content">
				<a href="<%=request.getContextPath()%>/ManagerUserController/showinformanger">Xem thông tin cá nhân</a>
