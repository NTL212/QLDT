...
public class ProjectController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
        	...
        	}else if (action.equals("/api/deleteproject")) {
        		deleteProjectAPI(request, response);
        	}
...
//        dispatcher.forward(request, response);
	...
	*/
    ...
    private void deleteProjectAPI(HttpServletRequest request, HttpServletResponse response)
    	    throws SQLException, IOException, ServletException {
    		    FormDataReader reader = new FormDataReader(request);
    		    Map<String, String> formData = reader.getData();
