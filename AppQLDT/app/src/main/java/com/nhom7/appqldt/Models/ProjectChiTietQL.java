...
public class ProjectChiTietQL implements Serializable {
    private String id;
    private String name;
    ...
    public ProjectChiTietQL() {
    }

    public ProjectChiTietQL(String projectCode, String name, String createDate, String description, int maxMember, String openRegDate, String closeRegDate, String startDate, String endDate, String acceptanceDate, double estBudget, String result, Topic topic, Lecturer lecturer, boolean isProposed) {
        this.id = projectCode;
        this.name = name;
