...
public class ThongBaoDaGuiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thong_bao_da_gui);
        ...
        call.enqueue(new Callback<APIResponse<List<Notification>>>() {
            ...
            public void onResponse(Call<APIResponse<List<Notification>>> call, Response<APIResponse<List<Notification>>> response) {
                if(response.isSuccessful()){
                    ...
                    ThongBaoAdapter thongBaoAdapter = new ThongBaoAdapter(thongBaoList, ThongBaoDaGuiActivity.this, true);
                    LinearLayoutManager linearLayoutManager = new LinearLayoutManager(ThongBaoDaGuiActivity.this, LinearLayoutManager.VERTICAL, false);
