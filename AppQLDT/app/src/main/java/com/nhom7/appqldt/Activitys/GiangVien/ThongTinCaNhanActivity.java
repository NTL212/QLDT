...
//Lấy giá trị được lưu giữ ra
                ...
                if (response.isSuccessful()) {
                    ...
                    btnChinhSua.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            SuaProfileDiaLog suaProfileDiaLog = new SuaProfileDiaLog();
                            suaProfileDiaLog.setLecture_Context(lecturer, ThongTinCaNhanActivity.this);
                            suaProfileDiaLog.show(getSupportFragmentManager(), "suaProfileDiaLog");
                        }
                    });
                }
                else {
    ...
    private void AnhXa(){
        ...
        btnChinhSua = findViewById(R.id.btnHienSuaThongTinDialog);
    }
